...
class Add_Club(FlaskForm):
    ...
    pro_photo = FileField('pro_photo',
                          validators=[DataRequired(), FileAllowed(['jpg', 'jpeg', 'png', 'gif'], 'Images only!')],
                          render_kw={"class": "form_pic custom-file-upload", "id": "inputFile", "accept": ".jpg,.jpeg,.png,.gif"})
    ...
    organiser = StringField('organiser', validators=[DataRequired()],
                            render_kw={"class": "form_organiser rounded-input"})
...
class Add_Notice(FlaskForm):
    ...
    photo = FileField('photo',
                      validators=[DataRequired(), FileAllowed(['jpg', 'jpeg', 'png', 'gif'], 'Images only!')],
                      render_kw={"class": "form_add add_in_order add_notice_prop",
                                 "id": "inputFile", "accept": ".jpg,.jpeg,.png,.gif"})
...
class Add_Event(FlaskForm):
    ...
    photo = FileField('photo',
                      validators=[DataRequired(), FileAllowed(['jpg', 'jpeg', 'png', 'gif'], 'Images only!')],
                      render_kw={"class": "form_add add_in_order add_event_prop",
                                 "id": "inputFile", "accept": ".jpg,.jpeg,.png,.gif"})
...
class Add_Photo(FlaskForm):
    ...
    description = StringField('description', validators=[DataRequired()],
                              render_kw={"class": "form_add_photo add_in_order", "placeholder": "Enter Photo Details"})
...
class Update_Club(FlaskForm):
    ...
    description = StringField('Description',
                              render_kw={"class": "form_change_desc rounded-input",
                                         "placeholder": "Enter New Description"})
    pro_photo = FileField('Profile Photo',
                          validators=[FileAllowed(['jpg', 'jpeg', 'png', 'gif'], 'Images only!')],
                          render_kw={"class": "form_change_file custom-file-upload",
                                     "id": "inputFile", "accept": ".jpg,.jpeg,.png,.gif"})
    club_room = StringField('Club Common Room',
                            render_kw={"class": "form_change_center rounded-input",
                                       "placeholder": "Enter New Club Room"})
    organiser = StringField('Organiser', render_kw={"class":
                                                    "form_change_organiser rounded-input",
...
class LoginForm(FlaskForm):
    email = EmailField("Email",
                       ...
                       render_kw={"class": "login", "placeholder": "Enter Email"})
    password = PasswordField("Password",
                             validators=[DataRequired()],
                             render_kw={"class": "login", "placeholder": "Enter Password"})
...
class SignupForm(FlaskForm):
    picture = FileField('Profile Photo',
                        validators=[DataRequired(), FileAllowed(['jpg', 'jpeg', 'png', 'gif'], 'Images only!')],
                        render_kw={"class": "signup_file", "id": "inputFile", "accept": ".jpg,.jpeg,.png,.gif"})
    name = StringField("Name",
                       validators=[DataRequired(), Length(max=20, message="Username must be within 20 characters")],
                       render_kw={"class": "signup", "placeholder": "Enter A Username"})
    email = EmailField("Email",
                       validators=[DataRequired(), Email()],
                       render_kw={"class": "signup",
                                  "placeholder": "Enter An Email"})
    password = PasswordField("Password",
                             validators=[DataRequired(), EqualTo('repassword', message="Passwords must match")],
                             render_kw={"class": "signup", "placeholder": "Enter A Password"})
